...
which can be seen in Figure~\ref{fig:translateFinalCard}. In most cases, it is
...
with a stylized ``\textit{i}'' in the center. By tapping on this button, a
separate UI element will appear containing the translated text. Since this
button is cast into the world using the AR camera, the button appears to be
placed directly on top of the content.
...
% TODO add photos of us testing it
