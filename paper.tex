...
% The paper headers
\markboth{Worcester Polytechnic Institute Major Qualifying Project}%
{Kyoto VR MQP Paper First Draft}
...
\IEEEPARstart{T}{his} is a sample paragraph that exists as a placeholder because
...
\IEEEPARstart{A}{s} smartphones and mobile technology becomes more prevalent,
...
\IEEEPARstart{I}{n} this section we explain the methodology of our project,
...
\IEEEPARstart{C}{onclusions} are typically hard to write, so we'll save it for
