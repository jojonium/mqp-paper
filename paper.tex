...
\includegraphics[width=0.5\textwidth]{sign-translation.png} \caption{Translated
sign using AR camera} \label{fig:signTranslation}
\end{figure}
...
\subsection{Frontend Web Application Testing}
\label{sec:frontendWebApplicationTesting}
