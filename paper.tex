...
it on the ground where the user was pointing. 
%TODO provide a figure of the AR cube
...
field that could accomodate varying amounts of text, since the audio files
...
Kyoto~VR. ARuko is not quite ready to be sold on app stores yet, but with a
little more development time it could easily be completed. The UI could use
more testing with real users to make sure it is intuitive and easy to use. We
also intended to add a feature where the app could automatically download tour
files from the Editour server and import them without having to rebuild. We were
not able to complete this feature due to time constraints, but it could easily
be added because all of ARuko's business logic is abstracted and generalized to
