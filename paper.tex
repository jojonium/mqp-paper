...
the translated text appears in a separate UI element. In most cases, it is more
...
stylized ``\textit{i}'' in the center. By tapping on this button, a separate UI
...
project instead. 
% TODO could probably put an example pic here
