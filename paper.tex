...
points to create shorter strips. Each LED on the strip individually adressable,
...
design included two strips of twenty LEDs. The rate of the animation on the
first strip of LEDs represented blood flow out of the left ventricle.
