...
The backend implements a representational state transfer (REST) API, utilizing
HTTP methods to manipulate tour data on the server. For full documentation of
